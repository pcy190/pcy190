...
Chaoyuan Peng is a Ph.D. student at Zhejiang University, under the supervision of Yajin Zhou (https://yajin.org/) and Lei Wu (https://leiwu.org/). He has uncovered more than 100 vulnerabilities in Chrome, more than 30 vulnerabilities in AOSP, and several critical vulnerabilities in mainstream blockchain clients. He is currently an intern at Qwen, and previously interned at BlockSec, Ant Group, and GOSSIP. He was an Ethereum Protocol Fellow and a vice president of the ZJU Blockchain Association.
